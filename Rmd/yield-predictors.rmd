...
writeRaster(stack(tmu), filename = fp(p_clim, "tmu.tif"), overwrite = TRUE)
...
writeRaster(gdd30, filename = fp(p_clim, "gdd.tif"), overwrite = TRUE)
...
climnms <- c("rftot", "ndjftot", "^djfmtot", "^jfmtot", "jantot", "febtot",
             "octtot", "kdd", "gdd\\.", "gdd30", "nkilljan", "nkillfeb",
...
onms <- c("MAP", "MSP", "DJFMP", "JFMP", "JP", "FP", "OP", "KDD", "GDD", 
